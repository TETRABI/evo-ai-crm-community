class CreateContactCompanies < ActiveRecord::Migration[7.1]
  def change
    ...
    add_foreign_key :contact_companies, :accounts, column: :account_id
    ...
    add_index :contact_companies, [:account_id, :contact_id]
    add_index :contact_companies, [:account_id, :company_id]
