...
class ContactIdentifyAction
  ...
  def update_contact
    update_attributes = params.slice(*@attributes_to_update).reject do |_k, v|
      v.blank?
    ...
    update_attributes[:location] = '' if update_attributes[:location].nil?
    update_attributes[:country_code] = '' if update_attributes[:country_code].nil?

    @contact.attributes = update_attributes
